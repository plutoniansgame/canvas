...
import {
  AssignNftToCanvasSlotProps,
  CreateCanvasModelAccountsProps,
  CreateCanvasModelProps,
  CreateIncrementorProps,
  CreateNftCanvasProps,
  CreateSlotProps,
  FindCanvasModelProps,
  FindCanvasModelSlotProps,
  FindSlotIncrementorProps,
} from "./types";
/**
...
export class CanvasSdkClient {
  ...
  async createCanvasModelAccounts({
    canvasModelName,
  }: CreateCanvasModelAccountsProps) {
  ...
  findSlotIncrementor({ canvasModelAddress }: FindSlotIncrementorProps) {
  ...
  findCanvasModel({ canvasModelName, collectionMint }: FindCanvasModelProps) {
    return PublicKey.findProgramAddress(
      [
  ...
  async createNftCanvas({ canvasModelName }: CreateNftCanvasProps) {
    const collectionMint = Keypair.generate();
